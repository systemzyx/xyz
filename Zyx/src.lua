...
textbox.Size = UDim2.new(1, -20, 0.7, -20)
...
-- variables
local obfTemplates = {
	["simbuscatorWatermark"] = "--[[\n\t%s\n\tThis file was protected by crappy Zyx.fuscator\n--]]\n",
...
button.MouseButton1Click:Connect(function()
	...
	local success, result = pcall(function()
		return obfuscateScript(source, "wonder what you're doing here.. human")
	end)

	if success and result then
		writefile("Zyx_protected", result)
		print("✅ Obfuscation complete! Saved to a file")
	else
